...
This could mean a contest of strength for [[Caldera, the Cataclysm|The Cataclysm]], a persuasion check made against a fiend for [[Brazzeria]], or a survival check to track down a hunter exterminating wildlife for the [[Earth Mother]]. The DM is the final arbiter to decide if your request is answered. When you invoke a deity, you expend a use of prayer and gain a d8 to any single d20 roll (minus something like a random chart).
