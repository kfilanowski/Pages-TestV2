...
When you attack a magical "copy" of a creature, such as [[Ninja]]'s shadow clone or a [[Shadow Projection]], it applies the curse to the original creature instead of the copy. 

The curse can be removed by performing an elaborate 24 hour ritual to appease [[Hades]], which costs 2,000g.

If this curse successfully denies an attempt at resurrection, gain 1 GBP.