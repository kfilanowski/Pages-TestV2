...
<span style="color:rgb(192, 0, 0)">These rules apply to</span> [[Innate Technique|Innate Casting]].

\---

All spells have a [[Staff Component]]. Disarming a mage of their staff prevents them from casting using it.
...
<span style="color:rgb(192, 0, 0)">These rules do not apply to innate casting.</span>
