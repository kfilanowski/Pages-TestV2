...
All effects that grant [[elusive]] movement do not function against you while Evil Eye is active. Creatures can tell you still threaten to attack them in such cases.

If a creature tries to move around you using [[Avoid AoO (P)|avoid AoO]] while wield a reach weapon, you add a bonus to your reflex save equal to the perception bonus granted by Evil Eye.
## <span style="color:rgb(103, 254, 120)">1 - Hyper Body</span>
You get a +4 bonus to [[Fortitude]] saves. 
Your starting HP increases by 10. Each level after you gain an addition 4 hp.
...
## <span style="color:rgb(103, 254, 120)">11 - Hyper Army</span>
As a standard action, you can inspire all allies that can see you, giving them (10+4x[[LvL]] of creature) additional current and maximum hp until they rest, or until you are defeated.