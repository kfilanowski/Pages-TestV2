...
In general, I'd say that anything that can prevent you from making [[Unarmed Attack|unarmed attacks]] can also prevent you from using elemental blast/wave/techniques. Some exceptions can be made (like firebending's melt feature), but in general, standard methods of restraint should be sufficient to prevent most abilities from functioning.
## <span style="color:rgb(103, 254, 120)">Elemental Jank</span>
In the show, elemental attacks can originate from places other than directly where the attacker is standing.

I have simplified elemental blast to always be [[Ranged Attack|ranged attacks]] when used from a range, and letting you choose to make it ranged or melee when creatures are within your natural reach. Most abilities require you, or a spot near you, to be the origin point.
