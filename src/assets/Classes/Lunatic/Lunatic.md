...
| [[Memory]]               | 3+lvl            |
## <span style="color:rgb(103, 254, 120)">1 - Spell Preferences</span>
...
In addition, they get 6 [[+Cantrips]] and always memorize all [[Frogg Saran (T)]] techniques of spell levels they can cast.
## <span style="color:rgb(103, 254, 120)">1 - Innate Casting</span>
You can [[Innate Technique|Innately Cast]] [[Metronome]].
## <span style="color:rgb(103, 254, 120)">1 - Madness?</span>
By embracing his will you have little need for your own. Instead of taking a penalty to your will saves based on your negative [[WIS]], you gain a bonus (-2 wis=+2 will). Instead of gaining a bonus to your will save based off of your positive wisdom, you gain a penalty (+2 wis=-2 will).
...
Whenever you roll a natural 1 on a D20, gain a [[luck dice]]. The first time you are harmed by one of your own spells in a combat, gain a luck dice.

If you use anything to [[Advantage|Reroll]] a natural one, or have [[advantage]] and don't roll multiple 1s, you do not gain a luck dice. You can have an unlimited number of luck dice. With many saved up you hum/glow with power. At the start of each day if you have zero luck dice, gain one.
## <span style="color:rgb(103, 254, 120)">1 - Wild Magic</span>
...
## <span style="color:rgb(103, 254, 120)">2 - Lucky Number</span>
...
## <span style="color:rgb(103, 254, 120)">2 - Frog Friend</span> [[Companion]]
You are blessed! Gain the [[Pet]] feat with the following stipulations. 
- Your pet must always be a frog or frog-like creature.
- It only has 2 [[Polymorph List|adaptation points]], but automatically gets the tongue ability.
- Whenever your frog rolls a 5 or lower on an [[Attack Roll]], it triggers [[Wild Magic]], affecting the target of the attack instead of itself. This does not reset your wild magic.
- It can shrink to tiny size. Changing to tiny or increasing in size back to the usual as a swift action.
- Its base stats are changed to -1 [[WIS]] and +1 [[LUK]] 
- It has the [[T1 - Enlightened|enlightened]] deific boon instead of Animal Instincts, putting its WIS to -2.
## <span style="color:rgb(103, 254, 120)">2 - Refund</span> [[recharge]]
...
## <span style="color:rgb(103, 254, 120)">4 - Certified Expert</span>
You have advantage on [[Skill Check|skill checks]] and [[serendipity]] checks as long as nobody is watching you.
## <span style="color:rgb(103, 254, 120)">6 - Wilder Magic (recharge)</span> [[Su]] 
...
## <span style="color:rgb(103, 254, 120)">8 - Crazy Talk</span>
