...
Proficiency in a skill grants you a 2+(lvl) bonus to the skill.  Certain aspects of a skill might only be available to characters that are proficient in the skill and are denoted with a (P). The most advanced part of a skill require the [[Signature Skill]] feat and are denoted with a (SS).
